...
if(isset($_GET['id'])){
    ...
    $acc_active_query = "UPDATE `user` SET `acc_status` = 'inactive' WHERE `user`.`emp_id` = '$emp_id'";
    mysqli_autocommit($connection,FALSE);
    mysqli_query($connection, $acc_active_query);  
    mysqli_commit($connection);

    header("location: ./admin_accountTable.php");
}
?>
...
<div class="bigbox">
    ...
    <div class="rightside">
        ...
        <div>
            <button class="btnt users" onclick="location.href='admin_accountTable.php'">User Accounts</button>
            <button class="btnt req" onclick="location.href='admin_accReqTable.php'"><span>Account Requests</span>
            <?php
    ...
    <?php
        ...
        $user_result1=mysqli_query($connection,$active_user_query);
        ...
        <table id='empt'>
            ...
            <tr>
                ...
                <td>".$row['user_name']."</td>
                <td>
                    <a href='admin_accountTable.php?id=".$row['emp_id']."' class='rv_btn'> Deactivate </a> 

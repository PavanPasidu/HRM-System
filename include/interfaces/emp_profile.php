...
<body>
    <div class="bigbox">
            ...
            <div class = "sidebar" id="side_nav">
                ...
                <div>
                    <ul class="list-unstyled px-2">
                        ...
                        <li class="active"><a href ="emp_profile.php" class="text-decoration-none px-3 py-2 d-block"><i class="fa-solid fa-user"></i>Profile</li>
        ...
        <div class="rightside">
            ...
            <?php require_once("../emp_profile.php") ?>

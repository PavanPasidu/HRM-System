...
<?php
    if(isset($_POST['submit'])){
        ...
        $emp_added ="";
        if (mysqli_query($connection, $addemp_query) and
            mysqli_query($connection, $employment_query) and
            mysqli_query($connection, $sup_query) and
            mysqli_query($connection, $emg_query) and
            ...
            $emp_added = "Error : Employee adding failed";
        }
            ...
            <table style="color:black; margin:4%; padding: 5%; width:90%; height:100%;">
                    ...
                    <tr>
                        ...
                        <td><select name="pay_grade">
                            ...
                            <option value="Level 2">Lavel 02</option>

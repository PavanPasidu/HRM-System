            ...
            <div class = "sidebar" id="side_nav">
                ...
                <div>
                    <ul class="list-unstyled px-2">
                        ...
                        <li class="active"><a href ="admin_employers.php" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-users"></i>Employers</li>
                        <li class=""><a href ="admin_create_or_add.php" class="text-decoration-none px-3 py-2 d-block"><i class="fa-solid fa-user-plus"></i>Add employee</li>
                    </ul>
        ...
        <?php
            ...
            <table id='empt'>
                ...
                <tr>
                    ...
                    <td>".$row['dept_name']."</td>
                    <td>
                        <a href='admin_employeeTable.php?id=".$row['emp_id']."' class='rv_btn'> remove </a> 
                        <a href='admin_updateEmployee.php?id=".$row['emp_id']."' class='ed_btn'> edit </a> 
                    </td>
                </tr>
                ";
                }

...
<div class="bigbox">
    ...
    <div class="rightside">
        ...
        <div class="flexboxcontainer_leave">
            <a href="leaveform.php" class="btn"><div class="smbox">Leave Request</div></a>
            <a href="leavedetail.php" class="btn"><div class="smbox">Leave Details</div></a>
            <a href="remainingleaves.php" class="btn"><div class="smbox">Remaining Leaves</div></a>
            <a href="leaveapprove.php" class="btn"><div class="smbox">Leave Approve</div></a>
        </div>
